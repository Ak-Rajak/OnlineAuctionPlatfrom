    ...
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center bg-[#f8f8f8]">
      ...
      >
        ...
        <div className="p-8">
          ...
          >
            Sign in to continue to PrimeBid
          </motion.p>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-[16px] py-3 px-4 bg-[#f8f8f8] rounded-lg border border-gray-200 focus:outline-none focus:border-[#d6482b] focus:ring-1 focus:ring-[#d6482b] transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mt-1">
              <div className="flex items-center gap-2">
                <input 
                  type="checkbox" 
                  id="remember" 
                  className="h-4 w-4 rounded border-gray-300 text-[#d6482b] focus:ring-[#d6482b]" 
                />
                <label htmlFor="remember" className="text-sm text-gray-600">Remember me</label>
              </div>
              <Link to="/forgot-password" className="text-sm text-[#d6482b] hover:text-[#b8381e] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          >
            <p className="text-gray-600">
              ...
              <Link to="/sign-up" className="text-[#d6482b] font-medium hover:text-[#b8381e] transition-colors">
                Sign Up
              </Link>
            </p>
          </motion.div>
